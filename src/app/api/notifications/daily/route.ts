...
const DAILY_MESSAGES = [
  ...
  "Chaque filleul vous rapporte 20% de bonus. Partagez votre code et regardez vos revenus grimper ! 🚀",
  "Vos investissements génèrent 5% de gains quotidiens. N'attendez plus, commencez à investir aujourd'hui ! 💎",
  "Le parrainage est la clé ! 20% de bonus sur chaque dépôt de vos filleuls. C'est le moment de partager ! 🔑",
  "Investissez et profitez de 5% de rendement quotidien. Votre avenir financier commence ici ! 🌟",
  "Plus de filleuls, plus de gains ! 20% de commission sur chaque dépôt. Parrainez dès maintenant ! 🎯",
  ...
  "Votre réseau est votre richesse. 20% de bonus par filleul, c'est la puissance du parrainage ! 🌍",
