  ...
  return (
    <>
      ...
      <div className="px-[18px] py-4 flex-1 w-full overflow-y-auto">
        ...
        {/* Quick Guide Link */}
        <button onClick={() => setPage('guide')} className="w-full bg-gradient-to-r from-[#FBBF24] to-[#F59E0B] rounded-xl p-3.5 mb-4 flex items-center gap-3 border-none cursor-pointer shadow-[0_2px_12px_rgba(251,191,36,0.2)] transition-transform active:scale-[0.98]">
          <div className="w-10 h-10 rounded-xl bg-[rgba(255,255,255,0.25)] flex items-center justify-center shrink-0"><i className="fas fa-compass text-white text-[1rem]"></i></div>
          <div className="flex-1 text-left">
            <div className="text-[0.82rem] font-bold text-white">Guide & Analyses</div>
            <div className="text-[0.62rem] text-[rgba(255,255,255,0.8)]">Tout savoir pour bien investir · Signaux de marché</div>
          </div>
          <i className="fas fa-chevron-right text-white text-[0.7rem]"></i>
        </button>

        {/* Referral Gift Teaser */}
        <button onClick={() => setPage('profile')} className="w-full bg-gradient-to-r from-[#8B5CF6] to-[#7C3AED] rounded-xl p-3 mb-4 flex items-center gap-3 border-none cursor-pointer shadow-[0_2px_12px_rgba(139,92,246,0.15)] transition-transform active:scale-[0.98]">
          <div className="w-9 h-9 rounded-xl bg-[rgba(255,255,255,0.2)] flex items-center justify-center shrink-0 text-[1.1rem]">🎁</div>
          <div className="flex-1 text-left">
            <div className="text-[0.75rem] font-bold text-white">Un cadeau vous attend</div>
            <div className="text-[0.58rem] text-[rgba(255,255,255,0.7)]">Parrainez vos amis pour débloquer des horizons</div>
          </div>
          <i className="fas fa-chevron-right text-[rgba(255,255,255,0.6)] text-[0.65rem]"></i>
        </button>
    ...
    <div className="bg-[#060A14] min-h-screen flex items-center justify-center">
      <div id="app" className="w-full max-w-[430px] h-[100dvh] max-h-[932px] bg-[#F2F5F9] relative overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_0_120px_rgba(0,0,0,0.5)]">
        <style>{`
          ...
          @keyframes pulseGlow { 0%, 100% { box-shadow: 0 0 0 0 rgba(0, 200, 83, 0.5); } 50% { box-shadow: 0 0 0 8px rgba(0, 200, 83, 0); } }
          @keyframes claimPulse { 0%, 100% { box-shadow: 0 0 0 0 rgba(0, 200, 83, 0.5); transform: scale(1); } 50% { box-shadow: 0 0 0 10px rgba(0, 200, 83, 0); transform: scale(1.03); } }
        `}</style>
