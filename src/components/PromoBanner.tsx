...
const PROMOS: PromoItem[] = [
  {
    id: 'mission-daily',
    icon: 'fa-bullhorn',
    title: '🔥 Postez vos images de mission et gagnez 25 FCFA par image validée !',
    subtitle: 'Créez avec ChatGPT/DALL-E et postez vos images chaque jour',
    label: 'Missions',
    gradientFrom: '#0D9488',
    gradientTo: '#065F46',
    gradientMid: '#14B8A6',
  ...
  },
  {
    id: 'mission-goals',
    icon: 'fa-bullseye',
    title: '🎯 Chaque image validée vous rapproche de vos objectifs',
    subtitle: 'Postez des images chaque jour = un pas de plus vers la liberté financière',
    label: 'Missions',
    gradientFrom: '#0D9488',
    gradientTo: '#115E59',
    gradientMid: '#14B8A6',
