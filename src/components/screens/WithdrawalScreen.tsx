        ...
        {user.needsReferral && (
          <div className="rounded-xl p-3.5 flex items-start gap-3 mb-[18px] bg-[#FEE2E2] border-l-[3px] border-[#DC2626]">
            ...
            <div className="flex-1">
              ...
              <p className="text-[0.72rem] leading-relaxed text-[#991B1B]">Après {user.completedWithdrawals && user.completedWithdrawals >= 4 ? 'vos ' + user.completedWithdrawals + ' retraits' : '4 retraits'}, vous devez parrainer au moins {user.requiredReferrals} personne{user.requiredReferrals && user.requiredReferrals > 1 ? 's' : ''}. Vous avez {user.referralCount || 0} parrainé{user.referralCount === 1 ? '' : 's'}.</p>
