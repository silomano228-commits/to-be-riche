...
export const AD_CATALOG: AdItem[] = [
  ...
  { id: 'ad-reliance', company: 'Reliance', category: 'indien', headline: 'Vivre mieux ensemble', subheadline: 'Missions rémunérées, micro-prêts — tout pour les jeunes.', tagline: 'Growth is Life', cta: 'En savoir plus', gradient: 'linear-gradient(135deg, #15803D 0%, #22C55E 100%)', icon: 'fa-bolt', layout: 'split', accent: '#BBF7D0' },
